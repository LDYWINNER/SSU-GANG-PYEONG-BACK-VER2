...
export class CourseStringId1721906043381 implements MigrationInterface {
  name = 'CourseStringId1721906043381';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "course_likes" ADD "fk_course_id" uuid NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "course_review" ADD "courseId" uuid`);
    await queryRunner.query(
      `ALTER TABLE "course" DROP CONSTRAINT "PK_bf95180dd756fd204fb01ce4916"`,
    );
    await queryRunner.query(`ALTER TABLE "course" DROP COLUMN "id"`);
    await queryRunner.query(
      `ALTER TABLE "course" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "course" ADD CONSTRAINT "PK_bf95180dd756fd204fb01ce4916" PRIMARY KEY ("id")`,
    );
